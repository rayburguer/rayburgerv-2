...
export default function CartDrawer({ isOpen, onClose }: CartDrawerProps) {
    ...
    return (
        <>
            {isOpen && <div className="fixed inset-0 bg-black/60 backdrop-blur-sm transition-opacity z-[90]" onClick={onClose} />}
            <div className={`fixed top-0 right-0 h-full w-[90%] max-w-md bg-slate-950 border-l border-slate-800 shadow-2xl transform transition-transform duration-300 ease-out z-[100] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="flex flex-col h-full bg-slate-950 pb-32">
                    {/* Header */}
